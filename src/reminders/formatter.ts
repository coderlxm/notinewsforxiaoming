...
export function formatHelpMessage(): string {
  return [
    ...
    '• <code>/startggaddplayer 123456 Tokido</code> - 添加监控选手',
    '• <code>/startggaddevent tournament/combo-breaker-2026/event/street-fighter-6 ComboBreaker SF6</code> - 添加监控项目',
    '• <code>/fetchstartgg</code> - 手动检查一次 start.gg 状态变化',
    '• <code>/startggwatchlist</code> - 查看 start.gg 监控列表',
    '',
    '🤖 <b>自然语言对话：</b>',
