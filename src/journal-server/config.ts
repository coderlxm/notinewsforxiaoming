...
const environmentSchema = z.object({
  ...
  JOURNAL_PHOTO_DRIVE_CLIENT_ID: z.string().min(1),
  JOURNAL_PHOTO_DRIVE_CLIENT_SECRET: z.string().min(1),
  JOURNAL_PHOTO_DRIVE_REFRESH_TOKEN: z.string().min(1),
  JOURNAL_PHOTO_DRIVE_ROOT_FOLDER_ID: z.string().min(1),
...
export function loadJournalServerConfig(environment = process.env): JournalServerConfig {
  ...
  return {
    ...
    photoDriveClientId: parsed.JOURNAL_PHOTO_DRIVE_CLIENT_ID,
    photoDriveClientSecret: parsed.JOURNAL_PHOTO_DRIVE_CLIENT_SECRET,
    photoDriveRefreshToken: parsed.JOURNAL_PHOTO_DRIVE_REFRESH_TOKEN,
    photoDriveRootFolderId: parsed.JOURNAL_PHOTO_DRIVE_ROOT_FOLDER_ID,
